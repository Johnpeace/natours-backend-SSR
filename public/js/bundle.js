...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiaWFtZmlyb3BvIiwiYSI6ImNraWozbzNlcjFqOXAyeXF1YzQ5YmU2OHgifQ.7RskUI0lDQjOhd_ASgK6xw';
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            path = type === 'password' ? 'updateMyPassword' : 'updateMe';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: "/api/v1/users/".concat(path),
              data: data
            });
...
if (userPasswordForm) userPasswordForm.addEventListener('submit', function (event) {
  event.preventDefault();

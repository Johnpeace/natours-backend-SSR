...
// when you have your frontend on a different host e.g api.natours.com
// allow access only from www.natours.com
// app.use(cors({
...
// the body coming should be raw and not a json format, that is why this is not in the bookingRoute
// It's important it is before === express.json({ limit: '10kb' })
app.post(
  '/webhook-checkout',
